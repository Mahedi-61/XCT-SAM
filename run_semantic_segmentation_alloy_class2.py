...
#   6. max_epoch=20, patience=8: enough epochs to converge on 447 samples;
#      early stopping prevents overfitting to alloy-specific features before
#      XCT fine-tuning in stage 2 (handled by run_semantic_segmentation_class_2.py).
# ---------------------------------------------------------------------------
    ...
    for img_path, label_path, pred_mask in zip(
        ...
        if args.min_area > 0:
            ...
            for comp in range(1, n_comp + 1):
                if (labeled_mask == comp).sum() < args.min_area:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_path",          type=str,   default="AutogluonModels/alloy_class2",
...
# python3 run_semantic_segmentation_alloy_class2.py --dataset_dir datasets/alloy --output_dir  output/alloy/class2/val --data_name val_class2 --num_gpus 2 --batch_size 8 --rank 2

# --- Evaluate on validation set ---
# CUDA_VISIBLE_DEVICES=0 python3 run_semantic_segmentation_alloy_class2.py \
#   --dataset_dir datasets/alloy \
#   --ckpt_path   AutogluonModels/alloy_class2 \
#   --output_dir  output/alloy/class2/val \
