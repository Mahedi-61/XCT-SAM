...
dir_data = "./datasets/gan-generated"
testid = "test1"
class_id = 1#
hist_match = False
...
dir_out = "AutogluonModels/class_1/ddp_prediction_cache" #defect class 3
...
num_gpus = [0, 1] # 3 for class1, 4 for class 2, 4 for class 3
pref="/"
pref1 = ""
